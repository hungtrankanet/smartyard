...
// Always bypass license code requirement for TOP BEST GLOBAL
header("Location: system-requirements.php?license_code=topbestglobal-free-license&purchase_code=1234");
exit();
                                        ...
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                <div class="alert alert-success" role="alert" style="font-size: 15px;">
                                                    ...
                                                    <br><br>
                                                    If you see the "Invalid License Code" error, please read this article:&nbsp;<a href="https://codingest.net/knowledge-base?content=129" target="_blank"><strong>Invalid License Code</strong></a>
                                                </div>
                                            </div>
