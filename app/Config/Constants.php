...
//general
defined('VARIENT_VERSION')              || define('VARIENT_VERSION', '2.4');
...
//cache
defined('RSS_CACHE_REFRESH_TIME')       || define('RSS_CACHE_REFRESH_TIME', 600); // 10 minutes
defined('POPULAR_POSTS_REFRESH_TIME')       || define('POPULAR_POSTS_REFRESH_TIME', 7200); // 2 hours
defined('POPULAR_TAGS_REFRESH_TIME')       || define('POPULAR_TAGS_REFRESH_TIME', 7200); // 2 hours
//database
