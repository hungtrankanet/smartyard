        ...
        <section class="sidebar">
            ...
            <dv class="sidebar-scrollbar" style="display: block; height: 100%; min-height: 100%;">
                <ul class="sidebar-menu" data-widget="tree" style="padding-bottom: 160px;">
                    ...
                    <?php endif;
                    if (hasPermission('members') || hasPermission('industry_types')): ?>
                        <li class="treeview<?php isAdminNavActive(['members', 'industry-types']); ?>">
                            <a href="#"><i class="fa fa-handshake-o"></i> <span>Quản Lý Đối Tác</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                                <?php if (hasPermission('members')): ?>
                                    <li class="<?= (getSegmentValue(2) == 'members' && empty(getSegmentValue(3))) ? 'active' : ''; ?>">
                                        <a href="<?= adminUrl('members'); ?>"><i class="fa fa-circle-o"></i> Danh sách đối tác</a>
                                    </li>
                                    <li class="<?= (getSegmentValue(2) == 'members' && getSegmentValue(3) == 'add') ? 'active' : ''; ?>">
                                        <a href="<?= adminUrl('members/add'); ?>"><i class="fa fa-circle-o"></i> Thêm mới đối tác</a>
                                    </li>
                                    <li class="<?= (getSegmentValue(2) == 'members' && (getSegmentValue(3) == 'upload-cards' || getSegmentValue(3) == 'confirm-ocr')) ? 'active' : ''; ?>">
                                        <a href="<?= adminUrl('members/upload-cards'); ?>"><i class="fa fa-circle-o"></i> Upload Visit Card (AI OCR)</a>
                                    </li>
                                    <li class="<?= (getSegmentValue(2) == 'members' && getSegmentValue(3) == 'verify-logs') ? 'active' : ''; ?>">
                                        <a href="<?= adminUrl('members/verify-logs'); ?>"><i class="fa fa-history"></i> Nhật ký xác minh</a>
                                    </li>
                                    <li class="<?= (getSegmentValue(2) == 'members' && getSegmentValue(3) == 'posts') ? 'active' : ''; ?>">
                                        <a href="<?= adminUrl('members/posts'); ?>"><i class="fa fa-pencil-square-o"></i> Duyệt bài giới thiệu</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (hasPermission('industry_types') || hasPermission('members')): ?>
                                    <li class="<?= (getSegmentValue(2) == 'industry-types') ? 'active' : ''; ?>">
                                        <a href="<?= adminUrl('industry-types'); ?>"><i class="fa fa-briefcase"></i> Quản lý ngành nghề</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    ...
                    if (hasPermission('newsletter')): ?>
                        <li class="treeview<?php isAdminNavActive(['newsletter', 'newsletter-groups', 'newsletter-create-campaign']); ?>">
                            <a href="#"><i class="fa fa-paper-plane" aria-hidden="true"></i><span>Email Marketing</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                                <li class="nav-newsletter"><a href="<?= adminUrl('newsletter'); ?>"><i class="fa fa-bullhorn"></i> 1. Chiến Dịch Email</a></li>
                                <li class="nav-newsletter-groups"><a href="<?= adminUrl('newsletter-groups'); ?>"><i class="fa fa-users"></i> 2. Quản Lý Nhóm Email</a></li>
                                <li class="nav-newsletter-create"><a href="<?= adminUrl('newsletter-create-campaign'); ?>"><i class="fa fa-plus-circle"></i> + Tạo Chiến Dịch Mới</a></li>
                            </ul>
                        </li>
                    <?php endif; ?>
                    <li class="treeview<?php isAdminNavActive(['events', 'add-event', 'edit-event', 'event-registrations']); ?>">
                        <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i><span>Quản Lý Sự Kiện</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                        <ul class="treeview-menu">
                            <li class="nav-events"><a href="<?= adminUrl('events'); ?>"><i class="fa fa-list"></i> Danh Sách Sự Kiện</a></li>
                            <li class="nav-add-event"><a href="<?= adminUrl('add-event'); ?>"><i class="fa fa-plus-circle"></i> + Thêm Sự Kiện Mới</a></li>
                            <li class="nav-event-registrations"><a href="<?= adminUrl('event-registrations'); ?>"><i class="fa fa-users"></i> Danh Sách Đăng Ký</a></li>
                        </ul>
                    </li>
